...
##        return(self.mod(sum,283))
    ...
    def keyall(self,key=[0x0f470caf,0x15d9b77f,0x71e8ad67,0xc959d698]):
        ...
        key=[key[:]]
        for i in range(10):
            key.append(self.keyExpansion(key[i][:],i,self.__s_box))
        return key
    ...
    def __EandD(self,e=[],key=[],state='E'):
        ...
        for i in range(9):
            if state=='D':
                ...
                i=i+1
            #e=self.substitute_bytes(e,state)
            e=self.shiftrows(e,state)
            e=self.mixColumns(e,state)
